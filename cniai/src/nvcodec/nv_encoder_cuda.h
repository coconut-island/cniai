...
public:
    ...
    /**
     * @brief This is a static function to copy input data from host memory to device
     * memory. This function assumes YUV plane is a single contiguous memory segment.
     */
    static void
