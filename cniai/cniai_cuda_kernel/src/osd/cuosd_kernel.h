...
struct CircleCommand : cuOSDContextCommand {
    ...
    CircleCommand(int cx, int cy, int radius, int thickness, unsigned char c0,
...
struct TextCommand : cuOSDContextCommand {
    ...
    TextCommand() = default;
    TextCommand(int text_line_size, int ilocation, unsigned char c0, unsigned char c1,
...
void cuosd_launch_kernel(void *image_data0, void *image_data1, int width, int stride,
                         ...
                         bool have_rotatebox, const unsigned char *blur_commands,
                         int num_blur_commands, void *stream);
